...
func newHandler() http.Handler {
	...
	mux.HandleFunc("/api/v1/author/projects/{projectID}/comments", authorProjectCommentsHandler)
	...
	mux.HandleFunc("/api/v1/tags", hotTagsHandler)
	...
	mux.HandleFunc("/api/v1/admin/comments", adminCommentsHandler)
	mux.HandleFunc("/api/v1/admin/comments/{commentID}/hide", adminCommentModerationHandler)
	mux.HandleFunc("/api/v1/admin/comments/{commentID}/restore", adminCommentModerationHandler)
