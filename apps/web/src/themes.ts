...
export const themes: Theme[] = [
  {
    ...
    swatch: 'linear-gradient(135deg, #267d68 0%, #72b7a5 100%)',
    light: {
      ...inkLight,
      '--blue': '#267d68',
      '--blue-hover': '#1f6b59',
      ...
      '--focus-line': '#8fc3b4',
      '--app-bg':
        'radial-gradient(1100px 620px at 8% -12%, rgba(38,125,104,.10), transparent 62%), radial-gradient(900px 520px at 104% 4%, rgba(114,183,165,.07), transparent 60%), linear-gradient(180deg, #fbfcfb 0%, #f1f4f2 100%)',
    },
    dark: {
      ...inkDark,
      '--blue': '#65b89f',
      ...
      '--page': '#0e1210',
      '--surface': '#171d1a',
      '--surface-muted': '#1c2420',
      '--soft': '#232c28',
      '--soft-blue': '#183028',
      '--focus-line': '#417d6b',
      '--app-bg':
        'radial-gradient(1100px 620px at 8% -12%, rgba(101,184,159,.13), transparent 62%), radial-gradient(900px 520px at 108% 0%, rgba(31,90,72,.18), transparent 60%), linear-gradient(180deg, #0e1210 0%, #0a0e0c 100%)',
    },
  },
  {
    id: 'violet',
